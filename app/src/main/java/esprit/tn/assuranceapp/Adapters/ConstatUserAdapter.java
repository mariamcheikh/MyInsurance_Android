package esprit.tn.assuranceapp.Adapters;
...
public class ConstatUserAdapter extends RecyclerView.Adapter<ConstatUserAdapter.ConstatViewHolder> {


    private Context mCtx;
    private List<Constat> ConstatList;

    public ConstatUserAdapter(Context mCtx, List<Constat> constatlist) {
        this.mCtx = mCtx;
    ...
    public ConstatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.constat_list_user_row, null);
