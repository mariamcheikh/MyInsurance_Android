...
public class ContratUserAdapter extends RecyclerView.Adapter<ContratUserAdapter.ContratViewHolder> {


    private Context mCtx;
    private List<Contrat> ContratList;

    public ContratUserAdapter(Context mCtx, List<Contrat> ContratList) {
        this.mCtx = mCtx;
    ...
    public ContratViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.contrat_list_user_row, null);
