...
import esprit.tn.assuranceapp.Adapters.Constat.ConstatUserAdapter;
...
public class DisplayConstatUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CONNECTED_USER =  getIntent().getIntExtra("CONNECTED_USER",1);
       // System.out.println("connecteduser_constat"+CONNECTED_USER);
        setContentView(R.layout.activity_display_constat_user);
    ...
    private void loadConstats() {
        ...
        * */
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_DISPLAY_CONSTAT_USER+CONNECTED_USER,
                response -> {
                    try {
                        ...
                        ConstatUserAdapter adapter = new ConstatUserAdapter(DisplayConstatUserActivity.this, constatList);
