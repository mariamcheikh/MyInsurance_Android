...
import esprit.tn.assuranceapp.Adapters.Contrat.ContratAdminAdapter;
import esprit.tn.assuranceapp.Constants;
import esprit.tn.assuranceapp.Models.Contrat;
import esprit.tn.assuranceapp.R;

public class DisplayContratAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_contrat_admin);
    ...
    private void loadContrats() {
        ...
        * */
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_DISPLAY_CONTRAT_ADMIN,
                response -> {
                    try {
                        ...
                        ContratAdminAdapter adapter = new ContratAdminAdapter(DisplayContratAdminActivity.this, contratList);
